...
Docker will download the required images from the docker-compose file and setup the containers

After the setup is done,the Kafka connector and the Kafka clients jars need to be copid into the jobmanager and the taskamanger.
